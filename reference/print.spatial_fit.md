...
– which shows the same header plus the forest settings. It is what you
get by typing the object's name, and the quickest way to confirm a fit
used the data, predictors and CRS you meant. For fit quality use
