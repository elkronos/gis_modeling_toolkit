...
- [`fold_separation()`](https://elkronos.github.io/gis_modeling_toolkit/reference/fold_separation.md)
  ...
  300 points over a 1000-unit square with a fitted range of 292: blocks
  of 343 units are wider than the range, so
  [`make_folds()`](https://elkronos.github.io/gis_modeling_toolkit/reference/make_folds.md)
  ...
  them 23 units away. Blocks wider than the range leak wherever a test
